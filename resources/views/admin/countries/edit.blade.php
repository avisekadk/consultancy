    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.countries.update',$edit->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (session('success'))
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @if($edit->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $edit->image) }}" alt="Country Image" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                                @endif
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                @if($edit->image_1)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $edit->image_1) }}" alt="Country Image 1" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="seo_schema" id="seo_schema" rows="3">{{old('seo_schema', $edit->seo_schema)}}</textarea>
                            @error('seo_schema')
                            <i>{{$message}}</i>
                            @enderror
                        </div>
