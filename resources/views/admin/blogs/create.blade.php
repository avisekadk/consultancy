                    ...
                    <form action="{{route('admin.blogs.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="file" value="{{old('featured_image_1')}}" name="featured_image_1" class="form-control" id="featured_image_1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" value="{{old('featured_image_2')}}" name="featured_image_2" class="form-control" id="featured_image_2">
